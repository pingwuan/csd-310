""" 
    ...
    Creation Date: 10 July 2020
    Change Date: 2/3/2023
...
result = students.update_one({"student_id": "1007"}, {"$set": {"last_name": "Tsoni II"}})

# find the updated student document 
liara = students.find_one({"student_id": "1007"})

# display message
print("\n  -- DISPLAYING STUDENT DOCUMENT 1007 --")

# output the updated document to the terminal window
print("  Student ID: " + liara["student_id"] + "\n  First Name: " + liara["first_name"] + "\n  Last Name: " + liara["last_name"] + "\n")
